...
export default function Home() {
  return (
    <>
      <section className="z-10 bg-head-bg bg-no-repeat bg-cover bg-inherit md:bg-center flex flex-col items-center pt-3 md:pt-10 pb-8 md:pb-28 relative">
        <Header />
      ...
      <section className="bg-head2-bg bg-no-repeat bg-cover flex flex-col items-center">
        <Info />
      </section>
    </>
  )
